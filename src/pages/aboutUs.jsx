...
const AboutUsPage = () => {
    ...
    return (
        <main className="overflow-x-hidden bg-white">
            <section className="py-24 md:py-32 bg-slate-50 relative flex items-center min-h-[70vh]">
                <div className="container mx-auto px-6 text-center z-10">
                    ...
                    <p className="text-lg md:text-xl text-slate-600 max-w-3xl mx-auto animate-fade-in-up">
                ...
                <div className="container mx-auto px-6">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div className={`transition-all duration-1000 ${missionVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'}`}>
                            <h2 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">Cerita Kami Dimulai Dari Sebuah Mimpi.</h2>
                        ...
                        <div className="grid grid-cols-2 gap-6">
                            <div className={`bg-blue-50 p-8 rounded-2xl text-center transition-all duration-1000 delay-200 ${missionVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`}>
                                <Rocket className="w-12 h-12 text-blue-600 mx-auto mb-4" />
                                <h3 className="text-2xl font-bold text-slate-800">Visi Kami</h3>
                                <p className="text-slate-500 mt-2">Menjadi katalisator utama transformasi digital bagi bisnis di Indonesia.</p>
                            </div>
                            <div className={`bg-red-50 p-8 rounded-2xl text-center transition-all duration-1000 delay-400 ${missionVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-90'}`}>
                                <Users className="w-12 h-12 text-red-800 mx-auto mb-4" />
                                <h3 className="text-2xl font-bold text-slate-800">Misi Kami</h3>
                                <p className="text-slate-500 mt-2">Memberikan solusi digital inovatif dan kemitraan strategis yang mendorong pertumbuhan berkelanjutan.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section ref={valuesRef} className="py-20 bg-slate-50">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-bold text-slate-900">Nilai yang Kami Pegang Teguh</h2>
                        <p className="text-lg text-slate-600 mt-4 max-w-2xl mx-auto">Prinsip yang menjadi kompas dalam setiap langkah dan keputusan kami.</p>
                    </div>
            ...
            <section ref={teamRef} className="py-20 bg-white">
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-4xl md:text-5xl font-bold text-slate-900">Bertemu dengan Tim Profesional Kami</h2>
                        <p className="text-lg text-slate-600 mt-4 max-w-2xl mx-auto">Sekumpulan individu penuh semangat dengan keahlian beragam, bersatu untuk kesuksesan proyek Anda.</p>
                    </div>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-10 justify-center">
                        {teamMembers.map((member, index) => (
                            <div key={index} className={`text-center transition-all duration-700 ease-out ${teamVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{ transitionDelay: `${index * 150}ms` }}>
                                ...
                                <p className="text-slate-500 mt-2 max-w-xs mx-auto">{member.bio}</p>
                            </div>
                        ))}
                    </div>
                </div>
